...
export const countrySpecificIcpResultSchema = z.object({
  ...
  secondaryIndustries: z.array(industrySegmentSchema).optional().default([]),
  excludedIndustries: z.array(z.string()).optional().default([]),
  nicheSegments: z.array(z.string()).optional().default([]),
  ...
  secondaryPains: z.array(z.string()).optional().default([]),
  ...
  procurementContext: z.string().optional(),
  localizationRequirements: z.string().optional(),
